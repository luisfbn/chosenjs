...
I used Babeljs for Compatibility
...
(function () {
  ...
  Chosen = function (superClass) {
    ...
    Chosen.prototype.search_results_mouseup = function (evt) {
      ...
      var target;
      target = $(evt.target).hasClass("active-result") ? $(evt.target) : $(evt.target).parents(".active-result").first(); //Support Shift + Select
      ...
      if (this.holding_shift) {
        if (this.selected_elements.length < 1) {
          ...
          var selected = null;
          var direction = target.prevAll('.first-selected').length > 0 ? 'back' : 'forward';
          ...
          selected.each(function (i, elem) {
            _this2.result_highlight = $(elem);
            return _this2.result_select(evt);
          }); 
